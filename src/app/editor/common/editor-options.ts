...
export const INS_EDITOR_DEFAULT_OPTIONS: InsEditorOptions = {
  ...
  icons: {
    ...
    paragraph: 'pilcrow',
    tableRowAddBefore: 'between-vertical-start',
    tableRowAddAfter: 'between-vertical-end',
    tableRowDelete: 'trash',
    tableRowClear: 'remove-formatting',
    tableColAddBefore: 'between-horizontal-start',
    tableColAddAfter: 'between-horizontal-end',
