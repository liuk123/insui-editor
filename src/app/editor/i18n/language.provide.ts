...
export const INS_EDITOR_LANGUAGE_PROVIDERS = [
  ...
  {
    provide: INS_EDITOR_FONT_OPTIONS,
    useFactory: insExtractI18n('editorFontOptions'),
  },
  {
