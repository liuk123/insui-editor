...
import {InsImageAlignList} from './image-align-list';
import {INS_IMAGE_EDITOR_OPTIONS} from './image-editor.options';
import { InsActiveZone, InsButton, InsDropdown, InsIcon, WINDOW } from '@liuk123/insui';
...
export class InsImageEditor
    extends AbstractInsEditorResizable<InsEditableImage>
    implements OnInit
{
