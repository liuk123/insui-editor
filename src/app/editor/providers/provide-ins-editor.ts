...
// import {type InsBackgroundColorOptions} from '@taiga-ui/editor/extensions/background-color';
// import {type InsDetailsExtensionOptions} from '@taiga-ui/editor/extensions/details';
// import {type InsFontColorOptions} from '@taiga-ui/editor/extensions/font-color';
// import {type InsFontSizeOptions} from '@taiga-ui/editor/extensions/font-size';
// import {type InsImageExtensionOptions} from '@taiga-ui/editor/extensions/image-editor';
import {
    type Extension,
...
const EXTENSIONS = [
    ...
    //     default: false,
    //     async loader(options: Partial<Record<string, unknown>>) {
    //         const {InsVideo} = await import('@taiga-ui/editor/extensions/media');
    ...
    //     default: false,
    //     async loader(options: Partial<Record<string, unknown>>) {
    //         const {InsAudio} = await import('@taiga-ui/editor/extensions/media');
    ...
    //     default: false,
    //     async loader(options: Partial<Record<string, unknown>>) {
    //         const {InsSource} = await import('@taiga-ui/editor/extensions/media');
...
export function provideInsEditor(options: Partial<Options>): Provider;
export function provideInsEditor<O, S>(
